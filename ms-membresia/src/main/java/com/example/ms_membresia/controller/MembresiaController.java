...
import java.util.Map; // Agregado para poder leer el JSON
...
@RequestMapping("/api/v1/membresias") // La URL
...
public class MembresiaController {
    ...
    // Se usará así en Postman/Thunder Client: POST localhost:8082/api/v1/membresias/contratar
    @PostMapping("/contratar")
    public ResponseEntity<MembresiaModel> contratar(@RequestBody Map<String, String> request) {
        
        // Extraemos los valores que vienen dentro del JSON
        String rutAtleta = request.get("rutAtleta");
        String tipoPlan = request.get("tipoPlan");
        
        // Como el mapa recibe puros textos (String), transformamos el número a 'int'
    ...
    // 2. URL para ver la membresía actual de un atleta / METODO
    ...
    // 3. URL para ver todo el historial de pagos de un atleta / METODO
    ...
    // Desde aquí, Membresía usará el "teléfono" para pedirle datos a Asistencia / METODO
